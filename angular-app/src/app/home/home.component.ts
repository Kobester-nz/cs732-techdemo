    ...
    <div class="row row-cols-1 row-cols-md-3 g-4">
      <div class="col">
        <div class="card h-90" style="margin-left: 40%; margin-top:20%;">
          ...
          <img src="assets/images/react.png" class="card-img-top" alt="...">
          <div class="card-body" >
      ...
      <div class="col">
        <div class="card h-80" style="margin-top: 20%; ">
          <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/css/bootstrap.min.css" rel="stylesheet">
          <img src="assets/images/reactvsangular.jpeg" class="card-img-top" alt=".ds..">
          <div class="card-body" >
      ...
      <div class="col">
        <div class="card h-80" style="margin-right: 40%; margin-top:20%; ">
          <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/css/bootstrap.min.css" rel="stylesheet">
          <img src="assets/images/angular.png" class="card-img-top" alt="...">
          <div class="card-body" >
